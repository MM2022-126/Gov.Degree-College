    ...
    <PublicLayout>
      ...
      <section className="relative bg-primary py-16 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src={administrationBlock.src} alt="Administration Block of Government Graduate College Shahdara" loading="eager" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg">
              <img src={mosquePic2.src} alt="Masjid Rehmat-ul-Alameen at Government Graduate College campus" loading="lazy" className="w-full h-full object-cover aspect-[4/3]" />
            </div>
          </div>
        </div>
      </section>
