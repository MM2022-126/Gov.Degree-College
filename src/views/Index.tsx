    ...
    <PublicLayout>
      ...
      <section className="relative h-[70vh] md:h-[80vh] overflow-hidden">
        {heroSlides.map((slide, index) => (
          <div key={index} className={`absolute inset-0 transition-opacity duration-1000 ${index === currentSlide ? "opacity-100" : "opacity-0"}`}>
            <img src={typeof slide.image === 'string' ? slide.image : slide.image.src} alt={slide.title} loading={index === 0 ? "eager" : "lazy"} className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/news" className="text-sm text-primary hover:text-secondary font-medium transition-colors">All News →</Link>
              </div>
              {latestNews.length === 0 ? (
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/events" className="text-sm text-primary hover:text-secondary font-medium transition-colors">All Events →</Link>
              </div>
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={administrationBlock.src} alt="Government Graduate College campus view" loading="lazy" className="w-full h-full object-cover" />
        </div>
